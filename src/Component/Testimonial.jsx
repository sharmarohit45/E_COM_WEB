        ...
        <div className="container">
            ...
            <div className="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.3s">
                <div className="testimonial-item">
                    ...
                    <img className="rounded-circle mb-3" src="../../assets/img/testimonial-1.jpg" alt=""/>
                    <h4>Client Name</h4>
                ...
                <div className="testimonial-item">
                    ...
                    <img className="rounded-circle mb-3" src="../../assets/img/testimonial-2.jpg" alt=""/>
                    <h4>Client Name</h4>
                    <span>Profession</span>
                </div>
                <div className="testimonial-item">
                    ...
                    <img className="rounded-circle mb-3" src="../../assets/img/testimonial-3.jpg" alt=""/>
                    <h4>Client Name</h4>
                    <span>Profession</span>
                </div>
                <div className="testimonial-item">
                    ...
                    <img className="rounded-circle mb-3" src="../../assets/img/testimonial-4.jpg" alt=""/>
                    <h4>Client Name</h4>
                    <span>Profession</span>
                </div>
            </div>
